...
export default function Testimonials() {
  return (
    ...
    >
      ...
      {/* 3D Marquee */}
      <div className="relative flex h-[350px] sm:h-[450px] w-full flex-row items-center justify-center gap-1 overflow-hidden [perspective:300px]">
        <div
        ...
        >
          <Marquee pauseOnHover vertical className="[--duration:25s] [--gap:0.25rem]">
            {firstRow.map((review) => (
              <ReviewCard key={review.name} {...review} />
            ))}
          </Marquee>
          <Marquee reverse pauseOnHover vertical className="[--duration:25s] [--gap:0.25rem]">

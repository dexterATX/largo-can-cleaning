...
// Real gallery images with SEO-optimized filenames and alt text
const galleryImages = [
  {
    id: 1,
    img: '/residential-trash-cans-lined-up-largo.jpg',
    height: 600,
    title: 'Residential Bins Ready for Service',
    category: 'residential',
    alt: 'Four gray residential trash cans lined up outside Florida home ready for professional cleaning service in Largo',
  },
  {
    id: 2,
    img: '/sanitized-trash-can-interior-clean.jpg',
    height: 600,
    title: 'Sparkling Clean Interior',
    category: 'before-after',
    alt: 'Interior of professionally sanitized trash can showing spotless clean results after Largo Can Cleaning service',
  },
  {
    id: 3,
    ...
    category: 'residential',
    alt: 'Single residential trash can at curb between garage doors ready for professional cleaning pickup',
  },
  {
    id: 4,
    img: '/trash-recycling-bins-paver-driveway.jpg',
    height: 550,
    title: 'Florida Home Service',
    category: 'residential',
    alt: 'Two trash and recycling bins on paver driveway with beautiful Florida landscaping in Pinellas County',
  },
  {
    id: 5,
    img: '/three-trash-cans-residential-service.jpg',
    height: 580,
    title: 'Multiple Bin Cleaning',
    category: 'residential',
    alt: 'Three residential trash cans cleaned and returned to customer driveway in Largo Florida neighborhood',
  },
  {
    id: 6,
    ...
    category: 'process',
    alt: 'Largo Can Cleaning technician giving thumbs up next to four freshly cleaned trash cans with cleaning equipment',
  },
  {
    id: 7,
    img: '/recycling-trash-bins-row-cleaned.jpg',
    height: 620,
    title: 'Recycling & Trash Bins',
    category: 'residential',
    alt: 'Row of three blue recycling bins and three trash cans after professional sanitization service in Florida',
  },
  {
    id: 8,
    ...
    category: 'before-after',
    alt: 'Two freshly sanitized trash can interiors showing professional deep cleaning results by Largo Can Cleaning',
  },
  {
    id: 9,
    img: '/green-trash-can-cleaning-pressure-washer-largo.jpg',
    height: 600,
    title: 'Pressure Washing in Action',
    category: 'process',
    alt: 'Green residential trash can with lid open being cleaned with professional pressure washer equipment in Largo Florida',
  },
  {
    id: 10,
    img: '/before-after-trash-can-cleaning-comparison.jpg',
    height: 550,
    title: 'Before & After Comparison',
    category: 'before-after',
    alt: 'Side by side comparison of professionally cleaned trash can labeled October 26 versus dirty bin showing dramatic transformation',
  },
  {
    id: 11,
    img: '/cleaned-trash-can-before-after-garage.jpg',
    height: 620,
    title: 'Customer Transformation',
    category: 'before-after',
    alt: 'Green trash can marked CLEANED in garage with before photo on clipboard showing dramatic cleaning results in Florida',
  },
  {
    id: 12,
    img: '/green-bins-pressure-washer-equipment-largo.jpg',
    height: 580,
    title: 'Professional Equipment Setup',
    category: 'process',
    alt: 'Two green residential bins on driveway with professional pressure washer wand and cleaning bucket in Largo',
  },
  {
    id: 13,
    img: '/trash-can-cleaning-process-4-step-collage.jpg',
    height: 650,
    title: '4-Step Cleaning Process',
    category: 'process',
    alt: 'Four panel collage showing complete trash can cleaning process from dirty to sanitized with pressure washing in Florida',
  },
  {
    id: 14,
    img: '/multi-color-trash-cans-cleaned-service.jpg',
    height: 560,
    title: 'Multi-Bin Service Complete',
    category: 'residential',
    alt: 'Three different colored trash cans blue gray and green all professionally cleaned and sanitized by Largo Can Cleaning',
  },
]
